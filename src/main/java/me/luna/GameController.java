...
public class GameController {
    private static final double INITIAL_BORDER_SIZE = 1500;
    private static final int GAME_TICKS = 20;
    private static final int PVP_DELAY = 60 * 5;
    protected boolean hasGameStarted = false;
    private World world;
    private final Main plugin;
    private final long shrinkDelay = 60 * 5;
    ...
    public void startGame() {
        ...
        }.runTaskLater(plugin, (long) GAME_TICKS * PVP_DELAY);
    ...
    private void startShrinkTimer() {
        ...
        }.runTaskTimer(plugin, 2L * GAME_TICKS, 2 * GAME_TICKS * shrinkDelay);
    }
}
